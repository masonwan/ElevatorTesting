...
public class UserPanelUIEven extends JPanel {
	...
	JButton AlarmButtonOn = null; // removed /* by Wilson
	...
	public UserPanelUIEven(int numFloors, UserPanelColor buttonColor,
		...
		/*
		 * 
		 * GridBagConstraints gbc = new GridBagConstraints(); gbc.gridy = 1;
		 * 
		 * AlarmFactory.alarmConfig(this); AlarmButtonOn = new
		 * JButton(AlarmTextOn);
		 * AlarmButtonOn.setBackground(buttonColor.getJColor()); AlarmListener
		 * alarmOnListner = new AlarmListener();
		 * AlarmButtonOn.addActionListener(alarmOnListner); add(AlarmButtonOn ,
		 * gbc);
		 * 
		 * 
		 * AlarmButtonOff = new JButton(AlarmTextOff);
		 * AlarmButtonOff.setBackground(buttonColor.getJColor()); AlarmListener1
		 * alarmOffListner = new AlarmListener1();
		 * AlarmButtonOff.addActionListener(alarmOffListner); add(AlarmButtonOff
		 * , gbc); AlarmButtonOff.setEnabled(false);
		 * 
		 * /* **********************
		 */
